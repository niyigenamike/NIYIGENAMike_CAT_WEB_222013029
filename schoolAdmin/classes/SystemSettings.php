<?php
/*I have used OOP(OBJECT ORIENTED PROGRAMMING) because of that it is very easier to debug and
also in software mainenance and then this page will be in charge of 

creating session and more other settings needed in the project*/
